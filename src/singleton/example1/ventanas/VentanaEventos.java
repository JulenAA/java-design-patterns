...
import singleton.example1.singleton.ClaseLogSingleton;
import singleton.example1.vo.PersonaVo;

/**
 * interfaz de usuario que presenta varios botones para que el usuario que la
 * ejecuta presione y asi genere los eventos que se registraran en el objeto
 * singleton
 * 
 * @author chenao
 *
...
public class VentanaEventos extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == boton1) {
			contenido += fechaRegistro + ": " + miPersonaVo.getNombre()
					+ " Presionó el botón 1\n";
	...
	private String obtenerFechaHora() {
		...
		String hora = ("" + cal1.get(Calendar.DATE) + "/"
