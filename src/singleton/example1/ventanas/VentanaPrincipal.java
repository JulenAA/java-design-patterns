package singleton.example1.ventanas;
...
import singleton.example1.vo.PersonaVo;
import singleton.example1.ventanas.VentanaLog;
import singleton.example1.ventanas.VentanaEventos;

/**
 * Ventana Principal desde donde se escojen las diferentes opciones para el
...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	/**
	 * Permite establecer un valor dependiendo de la opcion seleccionada en el
	...
	public VentanaPrincipal(PersonaVo[] personas) {
		...
		comboItems.setModel(new javax.swing.DefaultComboBoxModel<String>(arregloItems));
	...
	private void muestraVentana(int comboSeleccionado) {
		...
		case 0:
			miLog = new VentanaLog();
			miLog.setVisible(true);
			break;
		case 1:
			miVentanaEventos = new VentanaEventos(listaPersonas[0]);
			miVentanaEventos.setVisible(true);
			break;
		case 2:
			miVentanaEventos = new VentanaEventos(listaPersonas[1]);
			miVentanaEventos.setVisible(true);
			break;
		case 3:
			miVentanaEventos = new VentanaEventos(listaPersonas[2]);
			miVentanaEventos.setVisible(true);
			break;
		default:
			JOptionPane.showMessageDialog(null, "Por definir");
			break;
		}
	}
}
