...
/**
 * Ventana que permite brindar un combo de opciones para que el usuario
 * seleccione un color en especifico, dicho color se visualizara en las
 * diferentes ventanas que observen el comportamiento de esta, la ventana cumple
 * el papel de observador y observable
 * 
 * @author chenao
 */
public class VentanaOpciones extends JFrame implements Observer, ActionListener {
	...
	String arregloColores[] = { "Seleccione", "Amarillo", "Azul", "Rojo",
			"Verde", "Negro", "Blanco", "Naranja" };
	...
	public VentanaOpciones(ClaseObservador observador) {
		...
		color.setModel(new javax.swing.DefaultComboBoxModel<String>(arregloColores));
