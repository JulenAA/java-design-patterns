...
public class MenuTestDrive {
	...
	public static void main(String[] args) {
		...
		mainCourse.add(new MenuItem("Crispy Chicken", false, 100.89));

		desserts.add(new MenuItem("Apple Pie", false, 15.59));

		desserts.add(new MenuItem("Cheesecake", false, 19.99));

		dinners.add(new MenuItem("Hotdogs", false, 6.05));

		dinners.add(new MenuItem("Spaghetti ", true, 30.89));
